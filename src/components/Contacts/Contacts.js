    ...
    <div className={css.container}>
      ...
      <ul className={css.list}>
        <li><FontAwesome fixedWidth name='envelope' />
          <a className='link' href='mailto:lev.ostanin@gmail.com'>lev.ostanin@gmail.com</a>
        </li>
        <li><FontAwesome fixedWidth name='telegram' />
          <a className='link' href='tg://resolve?domain=levkus'>@levkus</a>
        </li>
        <li><FontAwesome fixedWidth name='facebook' />
          <a className='link' target='_blank' href='http://facebook.com/levkus'>facebook.com/levkus</a>
        </li>
      </ul>
    </div>
  )
